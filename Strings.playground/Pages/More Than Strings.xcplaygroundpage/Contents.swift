...
let name = "Rose"
let moneySaved = 100
let item = "purple dress"
let place = "fancy restuarant"
let positiveFeeling = "excited"
let negativeFeeling = "sad"
let noun = "time"
let fancyDinnerString = "Today was a big day for, \(name). They had finally saved up \(moneySaved) dollars and were going to buy a \(item). They went to the \(place) feeling very \(positiveFeeling). But then they felt \(negativeFeeling). They were all out of \(noun)."
